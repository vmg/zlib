...
ZLIB_INTERNAL inline void crc_reset(deflate_state *const s)
{
#ifdef HAVE_PCLMULQDQ
...
ZLIB_INTERNAL inline void crc_finalize(deflate_state *const s)
{
#ifdef HAVE_PCLMULQDQ
    if (x86_cpu_has_pclmulqdq)
...
ZLIB_INTERNAL inline void copy_with_crc(z_streamp strm, Bytef *dst, long size)
{
#ifdef HAVE_PCLMULQDQ
    if (x86_cpu_has_pclmulqdq) {
